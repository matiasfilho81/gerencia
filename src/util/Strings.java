...
public enum Strings {
	...
	MENU_CADASTROS(
			...
			+ "2 - Mostrar somente funcionarios\n"
			+ "3 - Mostrar somente não funcionarios\n"
			+ "4 - Mostrar somente gerente\n"
			+ RETORNAR_MENU),
	OPCOES_ATUALIZAR("\n"
			+ CABECALHO
			+ "1 - Alterar nome\n"
	...
	TEM_SALARIO("Deseja inserir uma salario? (S/N)"),
	SALARIO("Digite o salario: "),
	...
	INFORME_NOME("Digite o nome ou parte do nome da pessoa ou funcionario(a): "),
	...
	SEM_OCORRENCIA_2("' encontrada!\n"
			+ RETORNANDO_MENU),
	VIROU_funcionario(" agora é um(a) funcionario(a)!"),
	ATUALIZADO("Atualizado com sucesso!"),
	NAO_ENCONTRADO("Cadastro não encontrado!"),
	NOVO_FUNCIONARIO("Novo(a) funcionario(a) cadastrado(a) com sucesso!"),
